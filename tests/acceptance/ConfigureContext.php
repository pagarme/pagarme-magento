...
class ConfigureContext extends RawMinkContext
{
    ...
    public function goToSystemConfigurationPage()
    {
        ...
        $page->find('css', '#payment_pagarme_v2_settings-head')->click();
    ...
    public function insertAnApiKey()
    {
        ...
        $page->find(
            ...
            array(
                'id',
                'payment_pagarme_v2_settings_general_api_key'
            )
    ...
    public function insertAnEncryptionKey()
    {
        ...
        $page->find(
            ...
            array(
                'id',
                'payment_pagarme_v2_settings_general_encryption_key'
            )
    ...
    public function enablePagarMeCheckout()
    {
        ...
        $select = $page->find(
            'css',
            '#payment_pagarme_v2_settings_checkout_active'
        );
    ...
    public function turnOnCustomerDataCapture()
    {
        $captureCustomerData = $this->getSession()->getPage()->find(
            'css',
            '#payment_pagarme_v2_settings_checkout_capture_customer_data'
        );
    ...
    public function changeTheBoletoHelperText()
    {
        $this->getSession()->getPage()->fillField(
            'payment_pagarme_v2_settings_checkout_boleto_helper_text',
            'Some info text'
        );
    }
    ...
    {
        $this->getSession()->getPage()->fillField(
            'payment_pagarme_v2_settings_checkout_credit_card_helper_text',
            'Some info text'
        );
    }
    ...
    {
        $this->getSession()->getPage()->fillField(
            'payment_pagarme_v2_settings_checkout_ui_color',
            '#ff00ff'
        );
    }
    ...
    {
        $this->getSession()->getPage()->fillField(
            'payment_pagarme_v2_settings_checkout_header_text',
            'Some info text'
        );
    }
    ...
    {
        $this->getSession()->getPage()->fillField(
            'payment_pagarme_v2_settings_creditcard_interest_rate',
            $interestRate
        );
    }
    ...
    {
        $this->getSession()->getPage()->fillField(
            'payment_pagarme_v2_settings_checkout_payment_button_text',
            'Pagar!'
        );
    }
    ...
    {
        $this->getSession()->getPage()->fillField(
            'payment_pagarme_v2_settings_checkout_title',
    ...
    {
        $this->getSession()->getPage()->fillField(
            'payment_pagarme_v2_settings_creditcard_max_installments',
            $maxInstallmets
        );
    }
    ...
    {
        $this->getSession()->getPage()->fillField(
            'payment_pagarme_v2_settings_checkout_button_text',
            'Pagar!'
        );
    }
    ...
    {
        $this->getSession()->getPage()->fillField(
            'payment_pagarme_v2_settings_creditcard_free_installments',
            $freeInstallments
        );
    }
    ...
    public function aCreditCardListToAllow()
    {
        ...
        $select = $page->find(
            'css',
            '#payment_pagarme_v2_settings_creditcard_allowed_credit_card_brands'
        );
        ...
        $savedCreditCardsBrands = explode(',', \Mage::getStoreConfig(
            'payment/pagarme_v2_settings/creditcard_allowed_credit_card_brands'
        ));
    ...
    {
        $this->getSession()->getPage()->fillField(
            'payment_pagarme_v2_settings_boleto_discount',
            $discount
        );
    }
    ...
    public function iSetBoletoDiscountModeTo($discountMode)
    {
        $select = $this->getSession()->getPage()->find(
            'css',
            '#payment_pagarme_v2_settings_boleto_discount_mode'
        );
