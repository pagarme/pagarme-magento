...
class PagarMe_V2_Core_Model_Postback extends Mage_Core_Model_Abstract
{
    const POSTBACK_STATUS_PAID = 'paid';
    const POSTBACK_STATUS_REFUNDED = 'refunded';

    /**
     * @var PagarMe_V2_Core_Model_Service_Order
     */
    protected $orderService;

    /**
     * @var PagarMe_V2_Core_Model_Service_Invoice
     */
    ...
    /**
     * @codeCoverageIgnore
     * @return PagarMe_V2_Core_Model_Service_Order
     */
    public function getOrderService()
    {
        if (is_null($this->orderService)) {
            $this->orderService = Mage::getModel('pagarme_v2_core/service_order');
        }
    ...
    /**
     * @codeCoverageIgnore
     * @param PagarMe_V2_Core_Model_Service_Order $orderService
     * @return void
     */
    public function setOrderService(PagarMe_V2_Core_Model_Service_Order $orderService)
    {
    ...
    /**
     * @codeCoverageIgnore
     * @return PagarMe_V2_Core_Model_Service_Invoice
     */
    public function getInvoiceService()
    {
        if (is_null($this->invoiceService)) {
            $this->invoiceService = Mage::getModel('pagarme_v2_core/service_invoice');
        }
    ...
    /**
     * @codeCoverageIgnore
     * @param PagarMe_V2_Core_Model_Service_Invoice $invoiceService
     * @return void
     */
    public function setInvoiceService(PagarMe_V2_Core_Model_Service_Invoice $invoiceService)
    {
    ...
    public function processPostback($transactionId, $currentStatus)
    {
        ...
        if (!$this->canProceedWithPostback($order, $currentStatus)) {
            throw new Exception(
                Mage::helper('pagarme_v2_core')->__('Can\'t proccess postback.')
            );
        }
