...
class PagarMe_V2_Checkout_Block_Info_Checkout extends Mage_Payment_Block_Info
{
    /**
     ...
     * @codeCoverageIgnore
     *
     * @return PagarMe_V2_Core_Model_Transaction
     */
    public function getTransaction()
    {
        ...
        if (is_null($this->transaction) && !is_null($order)) {
            $this->transaction = \Mage::getModel('pagarme_v2_core/service_order')
        ...
        if (is_array($additionalInformation)
            ...
            $this->transaction = \Mage::getModel('pagarme_v2_core/sdk_adapter')
                ->getPagarMeSdk()
                ->transaction()
